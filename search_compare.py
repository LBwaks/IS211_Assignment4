...
def main():
    ...
    for size in list_sizes:
        ...
        print(f"Sequential Search took {avg_sequential_search:.7f} seconds on average")
        print(
            f"Ordered Sequential Search took {avg_ordered_sequential_search:.7f} seconds on average"
        )
        print(
            f"Binary Search took {avg_binary_search_iterative:.7f} seconds on average"
        )
        print(
            f"Binary Search (Recursive) took {avg_binary_search_recursive:.7f} seconds on average"
        )
        print()
